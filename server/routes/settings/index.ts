...
import { URL } from 'url';
import bookDownloaderRoutes from './bookDownloader';
...
settingsRoutes.use('/bookDownloader', bookDownloaderRoutes);
settingsRoutes.use('/comicDownloader', comicDownloaderRoutes);
